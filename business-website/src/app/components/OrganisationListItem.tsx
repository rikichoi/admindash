...
export default function OrganisationListItem({
  ...
  return (
    <article className="flex group relative p-6 hover:border-[#00cca3] after:transition-all after:duration-1000 hover:bg-[#00cca31f] hover:-translate-y-2 hover:-translate-x-3 duration-300 ease-in-out transition-all max-h-96 flex-col border rounded-lg text-black">
      <div className="flex gap-3 object-contain border-b w-full items-center p-3">
        <div>
      ...
      <div className="flex object-contain w-full items-center p-3">
        <div className="flex-1 truncate text-ellipsis text-sm text-gray-800">
          <p>{organisation.description}</p>
        </div>
        <Link
          href={`/donate/${organisation._id}`}
          className="flex gap-2 group relative overflow-hidden transition-all ease-in-out duration-300 items-center mx-auto w-fit py-3 px-6 text-lg  text-white rounded-lg bg-[#1ab394] hover:bg-[#00cca3]"
        >
